...
stem:[q_a=(sin⁡\frac{180^{\circ}}{2}\vec{a},cos⁡\frac{180^{\circ}}{2})=(\vec{a},0)]
...
stem:[{q_1}{q_2}=(\vec{v_1},w_1)(\vec{v_2},w_2)=(w_1\vec{v_1}+w_2\vec{v_2}+\vec{v_1}×\vec{v_2}, {w_1}{w_2}-\vec{v_1}∙\vec{v_2})]
...
*_Any 3D rotation stem:[q=(sin⁡\frac{θ}{2}\vec{v},cos⁡\frac{θ}{2})] can be represented as a sequence of 2 flips stem:[q_a=(\vec{a},0)] and [q_b=(\vec{b},0)], such that_*
