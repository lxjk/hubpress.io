...
*_Any rotation in 3D space is equivalent to a single rotation of angle stem:[\textbf{θ}] along some axis stem:[\textbf{\vec{v}}]._*
...
*_Any 3D rotation is equivalent a unit quaternion stem:[\textbf{q}] that stem:[\textbf{\left|q\right|=1}]._*
...
*_Any 3D rotation equivalent to rotating angle stem:[\textbf{θ}] along axis stem:[\textbf{\vec{v}}] can be represented as a sequence of 2 flips along axis stem:[\textbf{\vec{a}}] and stem:[\textbf{\vec{b}}], such that stem:[\textbf{\vec{a}·\vec{v}=0}], stem:[\textbf{\vec{b}·\vec{v}=0}] and the angle from stem:[\textbf{\vec{a}}] to stem:[\textbf{\vec{b}}]: stem:[\textbf{<\vec{a},\vec{b}>=\frac{θ}{2}}]._*
...
*_Any 3D rotation stem:[\textbf{q=(sin⁡\frac{θ}{2}\vec{v},cos⁡\frac{θ}{2})}] can be represented as a sequence of 2 flips stem:[\textbf{{q_a=(\vec{a},0)}] and stem:[\textbf{q_b=(\vec{b},0)}], such that_*
[stem]
++++
\textbf{q=-{q_b}{q_a}}
++++
*_where stem:[\textbf{\vec{a}·\vec{v}=0}], stem:[\textbf{\vec{b}·\vec{v}=0}] and the angle from stem:[\textbf{\vec{a}}] to stem:[\textbf{\vec{b}}]: stem:[\textbf{<\vec{a},\vec{b}>=\frac{θ}{2}}]._*
